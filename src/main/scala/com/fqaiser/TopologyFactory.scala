...
//
//    def makeZooIdPartitioner[K, V](
//        extractZooIdFromKey: K => Int
...
//    }
//
//    val zooIdPartitioner: StreamPartitioner[ZooAndAnimalId, AnimalValue] =
//      new StreamPartitioner[ZooAndAnimalId, AnimalValue] {
//        override def partition(
//            topic: String,
//            key: ZooAndAnimalId,
//            value: AnimalValue,
...
//      .repartition(
//        Repartitioned.`with`(partitioner =
//          makeZooIdPartitioner[Int, FoodValue](zooId => zooId)
//        )(???, foodValueSerde)
//      )
//
//    val zooAnimalTable: KTable[ZooAndAnimalId, AnimalValue] = {
//      streamsBuilder
//        .table(animalsTopic)(Consumed.`with`(animalKeySerde, animalValueSerde))
...
//        .repartition(
//          Repartitioned.`with`(partitioner =
//            makeZooIdPartitioner[ZooAndAnimalId, AnimalValue](_.zooId)
//          )(???, animalValueSerde)
//        )
...
//      new TransformerSupplier[Int, FoodValue, KeyValue[Int, FoodEatenValue]] {
//        private def transformer()
//            : Transformer[Int, FoodValue, KeyValue[Int, FoodEatenValue]] =
//          new Transformer[Int, FoodValue, KeyValue[Int, FoodEatenValue]] {
//            var zooAnimalStateStore
//                : KeyValueStore[ZooAndAnimalId, AnimalValue] = _
...
//                .asInstanceOf[KeyValueStore[ZooAndAnimalId, AnimalValue]]
//            }
//
